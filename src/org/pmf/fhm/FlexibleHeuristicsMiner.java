...
import org.pmf.fhm.heuristics.model.cnet.CNet;
import org.pmf.fhm.heuristics.model.cnet.CNetNode;
import org.pmf.fhm.heuristics.model.dg.DG;
import org.pmf.fhm.heuristics.model.dg.DGNode;
import org.pmf.fhm.heuristics.model.dg.DGPair;
import org.pmf.fhm.heuristics.model.dg.DGSubSet;
import org.pmf.fhm.log.LogParser;
...
//            heuristicsMetrics.print();
    ...
    public FlexibleHeuristicsMiner(XLog log) {
        try {
...
//            heuristicsMetrics.print();
    ...
    public void mine() {
        ...
        heuristicsMetrics.dependencyGraph = new DG(heuristicsMetrics.countOfTasks, heuristicsMetrics.logInfo.taskNames);
        l1lSubSet.mergeToDG(heuristicsMetrics.dependencyGraph);
        l2lSubSet.mergeToDG(heuristicsMetrics.dependencyGraph);
        outSubSet.mergeToDG(heuristicsMetrics.dependencyGraph);
        inSubSet.mergeToDG(heuristicsMetrics.dependencyGraph);
        outPlusSubSet.mergeToDG(heuristicsMetrics.dependencyGraph);
        inPlusSubSet.mergeToDG(heuristicsMetrics.dependencyGraph);

//        heuristicsMetrics.dependencyGraph.print();
        ...
        for (Trace trace : heuristicsMetrics.logInfo.traces) {
            ...
            DGNode dgStartNode = heuristicsMetrics.dependencyGraph.dependencyGraphNodes.get(0);
            ...
            for (int i = 0; i < trace.getLength(); i++) {
                ...
                DGNode dgNode = heuristicsMetrics.dependencyGraph.dependencyGraphNodes.get(trace.getTask(i).getIndex() + 1);
                for (DGNode outNode : dgNode.outputSet) {
                    ...
                    } else if (outNode.index == heuristicsMetrics.dependencyGraph.dependencyGraphNodes.size() - 1) {
                        // start node
        ...
        for (Trace trace : heuristicsMetrics.logInfo.traces) {
            ...
            DGNode dgEndNode = heuristicsMetrics.dependencyGraph.dependencyGraphNodes.get(heuristicsMetrics
                    .dependencyGraph.dependencyGraphNodes.size() - 1);
